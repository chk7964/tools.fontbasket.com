...
export default function About() {
  ...
  <Script src="../kruti.js"></Script>
	...
	<div className="flex">
  <button className="bg-green-500 px-4 m-2 rounded"   name="converter" id="converter"  >Krutidev to Unicode</button>
  <button onClick={copy} className="bg-green-500 px-4 m-2 rounded  bt" data-clipboard-target="#unicode_text"> Copy</button>
  <button className="bg-green-500 px-4 p-2 m-2 rounded"   name="converter" onClick={reset}>Reset</button>
  </div>
